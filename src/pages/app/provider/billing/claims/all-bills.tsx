...
export const allBillStyle = makeStyles(() => ({
  main: {
    padding: "20px",
  },
  label: {
...
function AllBills() {
  const classes = allBillStyle();
  const { APPLY, PULL_FROM_EHR } = providerConstants;
          ...
          <Grid  container spacing={1.5}>
            ...
            <Grid item xs={4}>
              ...
              <Grid justifyContent="end" container gap="2%">
                <ButtonBase sx={formButtonStyle.pullButton}>
                  {PULL_FROM_EHR}
                </ButtonBase>
                <ButtonBase sx={formButtonStyle.applyButtonStyle}>
                  {APPLY}
                </ButtonBase>
              </Grid>
            </Grid>
