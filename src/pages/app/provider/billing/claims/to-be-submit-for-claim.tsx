...
export const submitForClaimStyle = makeStyles(() => ({
  main: {
    padding: "20px",
  },
  label: {
...
function ToBeSubmitForClaim() {
  const classes = submitForClaimStyle();
  const { SUBMIT_CLAIM } = providerConstants;
...
export default ToBeSubmitForClaim;
