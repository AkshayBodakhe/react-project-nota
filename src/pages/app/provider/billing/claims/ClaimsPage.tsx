...
const renderTabsData = [
  {
    name: "All Bills",
    path: "/claims/all-bills",
    lable: "all-bills",
    subPath: "/provider/billing/claims",
  },
  {
    name: "To-Be-Submit-For-Claim",
    path: "/claims/to-be-submit-for-claims",
    lable: "to-be-submit-for-claims",
  }, {
    name: "Claim Submitted",
    path: "/claims/claim-submitted",
    lable: "claim-submitted",
  }, {
    name: "Secondary Claim To Be Submitted",
    path: "/claims/secondary-claim-to-be-submitted",
    lable: "secondary-claim-to-be-submitted",
  },
];
...
function ClaimsPage() {
  ...
  const RenderButton: React.FC<RenderButtonProps> = ({
    ...
    const toPath = `/provider/billing/claims/${label}`;
    return (
      <Link to={toPath}>
        <ButtonBase
          className={
            subPath !== "" && subPath === currentPath
