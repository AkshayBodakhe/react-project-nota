...
function RiskBehaviorScreening(props: PatientData) {
  ...
  const [riskBehaviorScreening, setRiskBehaviorScreening] = useState([]);
  ...
  useEffect(() => {
    if (data?.data) {
      ...
      setRiskBehaviorScreening(newRows);
      setPagination((prev) => ({
        ...prev,
        ...
        <Grid py={1}>
          ...
          >
            <Table stickyHeader aria-label="sticky table">
              ...
              <TableBody>
                {riskBehaviorScreening &&
                  !isLoading &&
                  riskBehaviorScreening.map((row: any, index: any) => {
                    return (
                      <TableRow
                        key={index}
          ...
          {isLoading && <Loading />}
          {riskBehaviorScreening.length === 0 && !isLoading && (
            <div
              style={{
                display: "flex",
        ...
        >
          <DialogTitle>
            <Grid container alignItems={"center"}>
              ...
              >
                <Typography>{ADD_RISK_SUB_TITLE}</Typography>
              </Grid>
...
export default RiskBehaviorScreening;
