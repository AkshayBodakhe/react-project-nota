...
function FamilyPlanning(props: PatientData) {
    ...
    <>
      <Box p={1}>
        ...
        <Grid py={1}>
          ...
          >
            <Table stickyHeader aria-label="sticky table">
              ...
              <TableBody>
                {familyPlanning &&
                  !isLoading &&
                  familyPlanning.map((row: any, index: any) => {
                    return (
                      <TableRow
                        key={index}
          ...
          {isLoading && <Loading />}
          {familyPlanning.length === 0 && !isLoading && (
            <div
              style={{
                display: "flex",
        ...
        >
          <DialogTitle>
            <Grid container alignItems={"center"}>
              ...
              >
                <Typography>{ADD_FAMILY_PLANNING}</Typography>
              </Grid>
