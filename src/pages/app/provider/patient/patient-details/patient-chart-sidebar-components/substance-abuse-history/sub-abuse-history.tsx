...
function SubstanceAbuseHistory(props: PatientData) {
  ...
  useEffect(() => {
    if (data?.data) {
      ...
      setSubstanceAbuseHistory(newRows);
      setPagination((prev) => ({
        ...prev,
    ...
    <>
      <Box p={1}>
        ...
        <Grid py={1}>
            ...
            <Table stickyHeader aria-label="sticky table">
              ...
              <TableBody>
                {substanceAbuseHistory &&
                  !isLoading &&
                  substanceAbuseHistory.map((row: any, index: any) => {
                    return (
                      <TableRow
                        key={index}
          ...
          {isLoading && <Loading />}
          {substanceAbuseHistory.length === 0 && !isLoading && (
            <div
              style={{
                display: "flex",
        ...
        >
          <DialogTitle>
            <Grid container alignItems={"center"}>
              ...
              >
                <Typography>{ADD_SUBSTANCE_TITLE}</Typography>
              </Grid>
