...
function HivAidsAndOtherStdEducation(props: PatientData) {
  ...
  useEffect(() => {
    if (data?.data) {
      ...
      setHivAidsAndOtherStdEducation(newRows);
      setPagination((prev) => ({
        ...prev,
        ...
        <Grid py={1}>
          ...
          >
            <Table stickyHeader aria-label="sticky table">
              ...
              <TableBody>
                {hivAidsAndOtherStdEducation &&
                  !isLoading &&
                  hivAidsAndOtherStdEducation.map((row: any, index: any) => {
                    return (
                      <TableRow
                        key={index}
          ...
          {isLoading && <Loading />}
          {hivAidsAndOtherStdEducation.length === 0 && !isLoading && (
            <div
              style={{
                display: "flex",
        ...
        >
          <DialogTitle>
            <Grid container alignItems={"center"}>
              ...
              >
                <Typography>{ADD_HIV_AID_TITLE}</Typography>
              </Grid>
...
export default HivAidsAndOtherStdEducation;
