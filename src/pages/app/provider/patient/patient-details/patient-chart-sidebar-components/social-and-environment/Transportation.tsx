...
function Transportation(props:PatientData){
    ...
    const {
        ...
        socialAndEnvironmentalSupportType:'TRANSPORTATION',
    ...
    useEffect(() => {
        ...
        const displayedRows = transportation.slice(
        page * rowsPerPage,
        (page + 1) * rowsPerPage
    );
