...
function SupportGroupsFamily(props:PatientData){
    const classes = commonWidget();
    const [supportGroupsFamily,setSupportGroupsFamily]=useState([]);
    ...
    const {
        ...
        socialAndEnvironmentalSupportType:'SUPPORT_GROUPS_FAMILY',
    ...
    useEffect(() => {
        ...
        setSupportGroupsFamily(newRows);
        setPagination((prev) => ({
            ...prev,
        ...
        const displayedRows = supportGroupsFamily.slice(
        page * rowsPerPage,
        (page + 1) * rowsPerPage
    );
...
export default SupportGroupsFamily
