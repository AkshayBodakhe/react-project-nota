...
function EmploymentSourcesOfIncome(props:PatientData){
    const classes = commonWidget();
    const [employmentSourcesOfIncome,setEmploymentSourcesOfIncome]=useState([]);
    ...
    const {
        ...
        socialAndEnvironmentalSupportType:'EMPLOYMENT_SOURCES_OF_INCOME',
    ...
    useEffect(() => {
        ...
        setEmploymentSourcesOfIncome(newRows);
        setPagination((prev) => ({
            ...prev,
        ...
        const displayedRows = employmentSourcesOfIncome.slice(
        page * rowsPerPage,
        (page + 1) * rowsPerPage
    );
...
export default EmploymentSourcesOfIncome
