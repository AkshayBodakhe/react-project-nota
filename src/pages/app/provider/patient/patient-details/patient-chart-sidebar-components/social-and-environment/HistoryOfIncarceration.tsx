...
function HistoryOfIncarceration(props:PatientData){
    const classes = commonWidget();
    const [historyOfIncarceration,setHistoryOfIncarceration]=useState([]);
    ...
    const {
        ...
        socialAndEnvironmentalSupportType:'HISTORY_OF_INCARCERATION',
    ...
    useEffect(() => {
        ...
        setHistoryOfIncarceration(newRows);
        setPagination((prev) => ({
            ...prev,
        ...
        const displayedRows = historyOfIncarceration.slice(
        page * rowsPerPage,
        (page + 1) * rowsPerPage
    );
...
export default HistoryOfIncarceration
