...
function FoodAssistance(props:PatientData){
    ...
    const {
        ...
        socialAndEnvironmentalSupportType:'FOOD_ASSISTANCE',
    ...
    useEffect(() => {
        ...
        const displayedRows = foodAssistance.slice(
        page * rowsPerPage,
        (page + 1) * rowsPerPage
    );
