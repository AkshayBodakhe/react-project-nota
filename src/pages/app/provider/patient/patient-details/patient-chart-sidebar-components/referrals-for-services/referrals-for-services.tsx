...
function ReferralsForServices(props: PatientData) {
  ...
  const [referralsForServices, setReferralsForServices] = useState([]);
  ...
  const {
    mutateAsync: createCarePatientChartMutate,
  ...
  useEffect(() => {
    if (data?.data) {
      ...
      setReferralsForServices(newRows);
      setPagination((prev) => ({
        ...prev,
        ...
        <Grid py={1}>
          ...
          >
            <Table stickyHeader aria-label="sticky table">
              ...
              <TableBody>
                {referralsForServices &&
                  !isLoading &&
                  referralsForServices.map((row: any, index: any) => {
                    return (
                      <TableRow
                        key={index}
          ...
          {isLoading && <Loading />}
          {referralsForServices.length === 0 && !isLoading && (
            <div
              style={{
                display: "flex",
        ...
        >
          <DialogTitle>
            <Grid container alignItems={"center"}>
              ...
              >
                <Typography>{ADD_REFERRALS_TITLE}</Typography>
              </Grid>
...
export default ReferralsForServices;
