...
function NoteForResp(props: noteDialogProps) {
    ...
    <>
      ...
      >
        <DialogTitle id="scroll-dialog-title">
          <Grid container justifyContent={"space-between"}>
            <Typography variant="h3">
              {"Enter Note for Respiration Rate (RR)"}
            </Typography>
        ...
        <DialogContent>
          <DialogContentText>
            <InputBase
              name={"objective.patientVitals[3].note"}
              onChange={formikData.handleChange}
              value={formikData?.values?.objective?.patientVitals[3]?.note}
              fullWidth
