...
function NoteForBMI(props: noteDialogProps) {
    ...
    <>
      ...
      >
        <DialogTitle id="scroll-dialog-title">
          <Grid container justifyContent={"space-between"}>
            <Typography variant="h3">
              {"Enter Note for Body Mass Index (BMI)"}
            </Typography>
        ...
        <DialogContent>
          <DialogContentText>
            <InputBase
              name={"objective.patientVitals[1].note"}
              onChange={formikData.handleChange}
              value={formikData?.values?.objective?.patientVitals[1]?.note}
              fullWidth
