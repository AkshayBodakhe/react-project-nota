...
function NoteForTemperature(props: noteDialogProps) {
    ...
    <>
      ...
      >
        <DialogTitle id="scroll-dialog-title">
          <Grid container justifyContent={"space-between"}>
            <Typography variant="h3">
              {"Enter Note for the Temperature"}
            </Typography>
        ...
        <DialogContent>
          <DialogContentText>
            <InputBase
              name={"objective.patientVitals[6].note"}
              onChange={formikData.handleChange}
              value={formikData?.values?.objective?.patientVitals[6]?.note}
              fullWidth
...
export default NoteForTemperature;
