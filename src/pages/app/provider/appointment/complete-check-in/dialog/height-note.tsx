...
function NoteForHeight(props: noteDialogProps) {
      ...
      >
        <DialogTitle id="scroll-dialog-title">
          <Grid container justifyContent={"space-between"}>
            <Typography variant="h3">{"Enter Note for the Height"}</Typography>
        ...
        <DialogContent>
          <DialogContentText>
            <InputBase
              name={"objective.patientVitals[4].note"}
              onChange={formikData.handleChange}
              value={formikData?.values?.objective?.patientVitals[4]?.note}
              fullWidth
