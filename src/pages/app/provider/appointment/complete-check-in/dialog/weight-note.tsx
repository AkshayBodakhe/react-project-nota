...
function NoteForWeight(props: noteDialogProps) {
      ...
      >
        <DialogTitle id="scroll-dialog-title">
          <Grid container justifyContent={"space-between"}>
            <Typography variant="h3">{"Enter Note for the Weight"}</Typography>
        ...
        <DialogContent>
          <DialogContentText>
            <InputBase
              name={"objective.patientVitals[5].note"}
              onChange={formikData.handleChange}
              value={formikData?.values?.objective?.patientVitals[5]?.note}
              fullWidth
