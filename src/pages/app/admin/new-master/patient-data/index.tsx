...
import {
  useMigrationControllerServiceGetViewPatientRecords,
...
const columns = [
  ...
  { id: "providerName", label: "Primary Provider Name", minWidth: 150 },
  { id: "phoneNumber", label: "Contact Number", minWidth: 150 },
...
export default function PatientDataTab(props: ProviderInterface) {
