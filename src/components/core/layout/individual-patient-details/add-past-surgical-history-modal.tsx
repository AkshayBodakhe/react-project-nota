...
// export const addpastsurgicalStyles = makeStyles(() => {
//   return {
//     modal: {
//       display: "flex",
//       alignItems: "center",
...
// interface AddPastSurgicalHistoryModalProps {
//   open: boolean;
//   onClose: () => void;
...
// export const AddPastSurgicalHistoryModal: React.FC<
//   AddPastSurgicalHistoryModalProps
// > = ({ open, onClose, onEventSuccessModalOpen, title }) => {
//   const classes = addpastsurgicalStyles();
...
//     setPastSurgicalHistory((prevData) => ({
//       ...prevData,
//       [name]: value,
//     }));
//   };
...
//             <InputBase
//               name="surgeryname"
//               value={pastsurgicalhistory.surgeryname}
//               fullWidth
...
//               fullWidth
//               name="note"
//               value={pastsurgicalhistory.note}
...
//             <ButtonBase className={classes.addpshbutton} onClick={handleSubmit}>
//               <Typography variant="h4" className={classes.addpshtypo}>
//                 Save PSH
//               </Typography>
//             </ButtonBase>
//           </Grid>
